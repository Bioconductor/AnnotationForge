...
## 4) Some examples (see below) don't work, if it's because there is
...
## Code should 1) see if NCBI.sqlite exists (if not make one) and then
## 2) use the data in there to pre-compute which things are viable for
## making into DBs.
